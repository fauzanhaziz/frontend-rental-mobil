...
// Interface murni tanpa 'any' menggunakan generic Recharts
interface ChartTooltipContentProps<TValue extends ValueType, TName extends NameType> 
  ...
  labelFormatter?: (label: React.ReactNode, payload: Payload<TValue, TName>[]) => React.ReactNode;
  labelClassName?: string;
  formatter?: (value: TValue, name: TName, item: Payload<TValue, TName>, index: number, payload: Payload<TValue, TName>[]) => React.ReactNode;
  color?: string;
  nameKey?: string;
  labelKey?: string;
}
          ...
          return (
            ...
            >
              {formatter && item?.value !== undefined && item.name !== undefined ? (
                formatter(item.value, item.name as TName, item, index, payload)
              ) : (
                <>
                  {itemConfig?.icon ? (
                    <itemConfig.icon />
